...
class ScriptHandler
{
  ...
  /**
   * Merge NYPL Design System assets to custom theme.
   *
   * @return void
   */
  public static function mergeDesignSystemAssets()
  {
    // Ensure vendor/nypl/nypl-design-system/source exists and copy its
    // contents to the components directory.
    $webroot = static::getDrupalRoot(getcwd());
    $fs = new Filesystem();
    if ($fs->exists(getcwd() . '/vendor/nypl/nypl-design-system/source')) {
      $fs->copy(getcwd() . '/vendor/nypl/nypl-design-system/source/', $webroot . '/web/themes/custom/nypl_emulsify/components/');
    }
  }
