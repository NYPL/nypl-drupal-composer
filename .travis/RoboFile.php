...
class RoboFile extends \Robo\Tasks
{
     ...
     * The website's URL.
     */
    const DRUPAL_URL = 'http://host.docker.internal:8000';
    ...
    {
        if (file_exists('./web/modules/custom')) {
    ...
    protected function runUnitTests()
    {
        ...
        $tasks[] = $this->taskExecStack()
            ->dir('web')
            ->exec('../vendor/bin/phpunit -c core --testsuite unit --exclude-group Composer,DependencyInjection,PageCache,Setup --coverage-clover ../build/logs/clover.xml --verbose modules');
        return $tasks;
    }
